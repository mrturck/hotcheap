...
export function Flights({ flights }: { flights: WeatherFlight[] }) {
    ...
    function randomFlights(): void {
        ...
        const randomFlight = rankedFlights[Math.floor((Math.random()*rankedFlights.length))]
        const urlParams = {
            adults: "1",
            teens: "0",
            children: "0",
        ...
        window.open(`https://www.ryanair.com/gb/en/trip/flights/select?${new URLSearchParams(urlParams).toString()}`, "_blank")
    }
    ...
    return (
      <div className="mt-5 flex flex-col gap-2">
          ...
          <button className="border border-red-500 p-3" onClick={randomFlights}>Take me anywhere</button>
